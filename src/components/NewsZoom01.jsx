...
class NewsZoom01 extends Component {
    ...
    render() { 
        ...
        <div>
          ...
          <Row>
            ...
            <Col lg="8" md="6" sm="12"><img  className="image1" src="https://i.imgur.com/wsdusDh.png" alt="touchdown"/><h3 className="flyM"><strong>Huitième Touchdown pour Kenyan Drake</strong></h3>
            ...
            <ul>
                ...
                <li className="liste_news"><NavLink to="/newszoom03">Albert Wilson, des performances en déclin</NavLink></li>
