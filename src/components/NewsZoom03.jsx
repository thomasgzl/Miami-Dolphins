    ...
    render() {
        ...
        <div>
          ...
          <Row>
            ...
            <Col lg="8" md="6" sm="12"><img  className="image1" src="https://i.imgur.com/NLqgMAR.png" alt="touchdown"/><h3 className="flyM"><strong>Albert Wilson, des performances en déclin</strong></h3>
