...
class NewsZoom03 extends Component {
  render() {
    return (
      <div>
        <Container fluid>
          <Row>
            <Col className="offset-lg-1" lg="6" md="6" sm="12">
              <img
                className="image1"
                src="https://i.imgur.com/NLqgMAR.png"
                alt="touchdown"
              />
              <h3 className="flyM">
                <strong>Albert Wilson, des performances en déclin</strong>
              </h3>
              <p className="paragraphe_news">
            ...
            <Col lg="4" md="6" sm="12" className="image2">
              ...
              <ul>
                <li className="liste_news">
                  <NavLink to="/newszoom01" className="navlink">
                ...
                <li className="liste_news">
                  <NavLink to="/newszoom00" className="navlink">
                    Bobby McCain : l'homme volant !
                  </NavLink>
                </li>
                <li className="liste_news">
