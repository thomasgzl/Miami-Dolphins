...
class NewsZoom05 extends Component {
    ...
    render() { 
        ...
        <div>
          ...
          <Row>
            ...
            <Col lg="8" md="6" sm="12"><img  className="image1" src="https://i.imgur.com/YkDzk5P.png" alt="touchdown"/><h3 className="flyM"><strong>Une équipe prête au combat !</strong></h3>
