...
class NewsZoom00 extends Component {
    ...
    render() { 
        ...
        <div>
          ...
          <Row>
            ...
            <Col lg="8" md="6" sm="12"><img  className="image1" src="https://i.imgur.com/M86EaHm.png" alt="touchdown"/><h3 className="flyM"><strong>Bobby McCain : l'homme volant !</strong></h3>
