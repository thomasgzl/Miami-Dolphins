    ...
    render() { 
        ...
        <div>
          ...
          <Row>
            ...
            <Col lg="8" md="6" sm="12"><img  className="image1" src="https://i.imgur.com/XxqIdvk.png" alt="touchdown"/><h3 className="flyM"><strong>Adam Mer-Gase, le nouveau coach !</strong></h3>
